...
public class ArrayObj {
    public static void main(String[] args) {
            ...
            film[] filmer = new film[100];
                ...
                double innPris = Double.parseDouble(JOptionPane.showInputDialog("Skriv inn prisen på film. Close med 0"));
                String innTittel = JOptionPane.showInputDialog("Skriv inn tittel");
                    ...
                    while (antall < filmer.length && innPris > 0) {
                            ...
                            antall++;
                        innPris = Double.parseDouble(JOptionPane.showInputDialog("Skriv inn prisen på film. Close med 0"));
